...
pub fn handle_key_events(key_event: KeyEvent, app: &mut App) -> AppResult<()> {
    let evdev_key_code = match key_event.modifiers {
        KeyModifiers::CONTROL => EvdevKeyCode(29),
        KeyModifiers::ALT => EvdevKeyCode(56),
        KeyModifiers::META => EvdevKeyCode(125),
        KeyModifiers::SHIFT => EvdevKeyCode(42),
    ...
    if app.select_key_mode {
        if evdev_key_code == EvdevKeyCode(50) {
            app.selected_key = match key_event.modifiers {
                KeyModifiers::CONTROL => evdev_key_code,
                _ => evdev_key_code,
            };
        }
